...
let productos = [
    { imagen: './img/1.jpg', nombre: 'Composicion', precio: '$80' },
    { imagen: './img/2.jpg', nombre: 'Mezcla y mastering', precio: '$20' },
    { imagen: './img/3.jpg', nombre: 'Live dj set', precio: '$50' }
];
